...
##   $ docker build -t php-for-adscorp-automatedbuild1 .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-adscorp-automatedbuild1
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="rpihpnw" \
    STACKSMITH_STACK_NAME="PHP for adscorp/automatedbuild1" \
