...
##   $ docker build -t java-for-adscorp-automatedbuild1 .
##
## RUNNING
##   $ docker run java-for-adscorp-automatedbuild1

FROM gcr.io/bitnami-containers/minideb-extras:jessie-r12-buildpack

MAINTAINER Bitnami <containers@bitnami.com>

ENV STACKSMITH_STACK_ID="zyg4mhy" \
    STACKSMITH_STACK_NAME="Java for adscorp/automatedbuild1" \
